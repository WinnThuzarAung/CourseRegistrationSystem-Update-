...
namespace NewForm
{
    ...
    {
        AddNewCourse adf;
        public AddLevel (AddNewCourse add)
        {
            InitializeComponent();
            this.adf = add;
        }

        public AddLevel(AddLevel4 addLevel4)
        {
            AddLevel4 = addLevel4;
        }

        public AddLevel4 AddLevel4 { get; }

        private void AddLevel_Load(object sender, EventArgs e)
        {
            coursename.Text = adf.coursename1.Text;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
           AddLevel2 adl2 = new AddLevel2(this);
            adl2.ShowDialog();
            con.Close();
        }
